...
<head>
    ...
    <link rel="fineui-icon" href="images/logo.png">
    <meta http-equiv="Cache-Control" content="no-siteapp" />
    <title>汇天成智慧工厂管理系统</title>
...
<div class="layout-admin">
    ...
    <header class="layout-header">
        <span class="header-logo"><img alt="image" width="190" height="100%" src="images/logo_title.png" /></span>
...
<script type="text/javascript">
    ...
    function addNewTab(url,id,title){
        var options = {url:url,id:id,title:title};
        addFineuiTab(options);
    }
