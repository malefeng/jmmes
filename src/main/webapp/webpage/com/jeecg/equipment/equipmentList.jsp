            ...
            $('#equipmentList').datagrid({
                ...
                columns: [[
                    ...
                    formatter: function (value, rec, index) {
                        ...
                        var href = '';
                        href += "<a href='#'   class='ace_button'  onclick=delObj('equipmentController.do?del&id=" + rec.id + "','equipmentList')>  <i class=' fa fa-trash-o'></i> ";
                        href += "删除</a>&nbsp;";
                        return href;
                    }
                }
        ...
        <div id="equipmentListtb" style="padding:3px; height: auto">
            ...
            <div style="border-bottom-width:0;" class="datagrid-toolbar">
                <span style="float:left;">
                    <a href="#" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('录入','equipmentController.do?addorupdate','equipmentList',null,null)">录入</a>
                    <a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit" onclick="update('编辑','equipmentController.do?addorupdate','equipmentList',null,null)">编辑</a>
                    <a href="#" class="easyui-linkbutton" plain="true" icon="icon-search" onclick="detail('查看','equipmentController.do?addorupdate','equipmentList',null,null)">查看</a>
                </span>
