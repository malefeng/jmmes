...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="finishedProductionController.do?save">
			...
			<td class="value">
				<t:dictSelect field="needRipening" id="needRipening" defaultVal="${finishedProductionPage.needRipening}" typeGroupCode="needRipen" hasLabel="false" type="list"></t:dictSelect>
			</td>
			</tr>
