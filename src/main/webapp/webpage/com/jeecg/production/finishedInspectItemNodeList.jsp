	...
	<c:if test="${fn:length(finishedInspectItemNodeList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  <td align="left"><input name="finishedInspectItemNodeList[0].inspectTimes" class="inspectTimes" value="1" maxlength="32" type="text" style="width:120px;" ></td>
				...
				<td align="left"><t:dictSelect field="finishedInspectItemNodeList[0].inspectResult" typeGroupCode="inspeRes" readonly="true"></t:dictSelect></td>
				  <td align="left"><input name="finishedInspectItemNodeList[0].inspectDate" data-file="inspectDate" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" maxlength="" type="text" style="width:120px;" ></td>
	...
	<c:if test="${fn:length(finishedInspectItemNodeList)  > 0 }">
		<c:forEach items="${finishedInspectItemNodeList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<td align="left"><t:dictSelect field="finishedInspectItemNodeList[${stuts.index }].inspectState" defaultVal="${poVal.inspectState }" typeGroupCode="inspeType" readonly="true"></t:dictSelect></td>
				<td align="left"><t:dictSelect field="finishedInspectItemNodeList[${stuts.index }].inspectResult" defaultVal="${poVal.inspectResult }" typeGroupCode="inspeRes" readonly="true"></t:dictSelect></td>
				   <td align="left"><input name="finishedInspectItemNodeList[${stuts.index }].inspectDate" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" maxlength="" value="${poVal.inspectDate }" type="text" style="width:120px;"></td>
