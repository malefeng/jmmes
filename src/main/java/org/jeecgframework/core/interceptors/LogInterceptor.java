...
public class LogInterceptor {
	@Before("execution(* com.jeecg.controller.*.*.*(..))")
	...
	@After("execution(* com.jeecg.controller.*.*.*(..))")
	public void afterMethod(JoinPoint joinPoint){

		String toLongString = joinPoint.toLongString();
	}

	@AfterThrowing("execution(* com.jeecg.controller.*.*.*(..))")
