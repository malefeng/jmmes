...
public class BaseTag extends JeecgTag {
	...
	public StringBuffer end(){
		...
		if (oConvertUtils.isIn("common", types)) {
			sb.append("<script type=\"text/javascript\" src=\""+basePath+"/plug-in/common/js/common.js\"></script>");
		}
		if (oConvertUtils.isIn("print", types)) {
			sb.append("<script type=\"text/javascript\" src=\""+basePath+"/plug-in/lodop/LodopFuncs.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\""+basePath+"/plug-in/printthis/printWithLODOP.js\"></script>");
		}
		types = null;
		this.putTagCache(sb);
