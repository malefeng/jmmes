 ...
 */
@Entity
@Table(name = "t_semi_finished_inspect_list", schema = "")
@SuppressWarnings("serial")
public class SemiFinishedInspectEntity implements java.io.Serializable {
	/**id*/
	 ...
	 */
	@Column(name ="SEMI_FINISHED_NAME",nullable=true,length=32)
