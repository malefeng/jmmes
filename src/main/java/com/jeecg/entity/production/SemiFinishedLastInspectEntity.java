 ...
 */
@Entity
@Table(name = "t_semi_finished_last_inspect_list", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings("serial")
public class SemiFinishedLastInspectEntity implements java.io.Serializable {
	/**id*/
	 ...
	 */
	@Column(name ="SEMI_FINISHED_CODE",nullable=true,length=32)
	...
	@Column(name ="LAST_INSPECT_NUMBER",nullable=true,precision=10,scale=0)
