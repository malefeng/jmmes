 ...
 */
@Entity
@Table(name = "t_storage_list", schema = "")
@DynamicUpdate(true)
@DynamicInsert(true)
...
public class StorageEntity implements java.io.Serializable {
	 ...
	 */
	@Column(name ="STORAGE_NAME",nullable=true,length=120)
