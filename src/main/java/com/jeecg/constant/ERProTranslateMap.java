...
public class ERProTranslateMap {
    ...
    static {
        ...
        TRANSLATE_HEAD_PROPERTY = new String[]{"receiptCode","requisitionDate","requisitionWorkshopCode","repositoryCode","repositoryManagerCode",
                "acquirePersonCode","productionOrderNumber","productionDispatchingNumber","finishedCode","finishedName","plannedProductionQuantity","plannedStartDate","plannedCompletionDate","readPersonCode","acquireTime","creatorCode"};
        TRANSLATE_HEAD_TYPE = new Class[]{String.class, Date.class,String.class,String.class,String.class,
                String.class,String.class,String.class,String.class,String.class,String.class,Date.class,Date.class,String.class,Date.class,String.class,};
        ...
        TRANSLATE_DETAIL_PROPERTY = new String[]{"rawMaterialCode","rawMaterialName","rawMaterialSize","unit","rawMaterialNum","batchNumber","productionOrderNumber","finishedName"};
        TRANSLATE_DETAIL_TYPE = new Class[]{String.class,String.class,String.class,String.class,String.class,String.class,String.class,String.class};
    }
}
